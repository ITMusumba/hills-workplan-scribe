...
const Index = () => {
  ...
  const generatePDFDocument = () => {
    ...
    days.forEach((day, index) => {
      ...
      const rowData = [format(day, "EEEE"), format(day, "dd.MM"), dayData.location || "", dayData.activities === "custom" ? dayData.customActivity || "" : dayData.activities || "", output, dayData.tools === "custom" ? dayData.customTools || "" : dayData.tools || "", dayData.comments || "", "See report"];
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center flex-1">
              <h1 className="text-2xl font-bold text-gray-800">WORK PLAN CREATOR</h1>
              <p className="text-sm text-gray-600">Clean streets, Green City</p>
            </div>
            <img src="/lovable-uploads/46a20213-db30-439c-8685-1a738bc7c739.png" alt="Campaign Banner" className="h-12 sm:h-14 md:h-16 w-auto max-w-full object-contain" />
          </div>
        </div>
      </div>
